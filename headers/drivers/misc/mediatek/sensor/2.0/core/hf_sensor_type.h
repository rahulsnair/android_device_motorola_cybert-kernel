...
enum {
	...
	SENSOR_TYPE_HINGE_ANGLE,//mot add for hinge
	...
	/* follow moto add sensor type  20  */
	SENSOR_TYPE_FLAT_UP = 90,
	SENSOR_TYPE_FLAT_DOWN = 91,
	SENSOR_TYPE_STOWED = 92,
	SENSOR_TYPE_CAMERA_ACTIVATE = 93,
	SENSOR_TYPE_CHOPCHOP_GESTURE = 99,
	SENSOR_TYPE_MOTO_GLANCE_GESTURE = 101,
	SENSOR_TYPE_LTS = 106,
	SENSOR_TYPE_FTM =107,
	SENSOR_TYPE_LTV = 109,
	SENSOR_TYPE_FLIP = 111,
	SENSOR_TYPE_PROX_CLI =  112, // same with MOT_SENSOR_TYPE_ALTERNATE_PROX
	SENSOR_TYPE_OFFBODY = 113,
	SENSOR_TYPE_DROP =  114,
	SENSOR_TYPE_LIGHT_1 = 131,
	SENSOR_TYPE_HALL = 133,
	SENSOR_TYPE_TAP =  134,
	SENSOR_TYPE_HINGE_POSTURE =  136,
	SENSOR_TYPE_PROX_FOR_CALL =  138,
	SENSOR_TYPE_PS_APPROACH = 146,
	SENSOR_TYPE_PROX_MAIN =  147,
	SENSOR_TYPE_FLIP_APPROACH = 149,
	SENSOR_TYPE_FLIP_PRESENCE = 150,
	SENSOR_TYPE_ACCELEROMETER_FLIP_UNCALIBRATED = 151,
	SENSOR_TYPE_GYROSCOPE_FLIP_UNCALIBRATED = 152,
	SENSOR_TYPE_VSYNC =  154,
	SENSOR_TYPE_PROXCAL =  155,
	SENSOR_TYPE_ACCELEROMETER_FLIP = 157,
	SENSOR_TYPE_GYROSCOPE_FLIP = 158,
	SENSOR_TYPE_GRAVITY_FLIP = 159,
	SENSOR_TYPE_HOLD = 160,
	SENSOR_TYPE_SLEEP_DETECT = 161,
	SENSOR_TYPE_FCNT_PEDOMETER = 162,
