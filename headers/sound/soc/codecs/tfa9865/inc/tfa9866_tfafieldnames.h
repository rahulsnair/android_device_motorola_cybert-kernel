 ...
 *  This file was generated automatically on  11/09/23 at 14:40:20.
 *  Source file: TFA9866_GPA2_N1A3_I2C_RegisterMap.xlsx
 */
...
#define TFA9864N1A1_I2CVERSION    22
#define TFA9864N1A2_I2CVERSION    1
#define TFA9864N1A3_I2CVERSION    1

#define TFA9865N2A1_I2CVERSION    22
#define TFA9865N2A2_I2CVERSION    1
#define TFA9865N2A3_I2CVERSION    1

#define TFA9866N1A1_I2CVERSION    22
#define TFA9866N1A2_I2CVERSION    3
#define TFA9866_I2CVERSION    3

typedef enum tfa9866BfEnumList {
    ...
    TFA9866_BF_BSSR  = 0x50e0,    /*!< Battery voltage read out                           */
    ...
    TFA9866_BF_DCTRIP= 0x7444,    /*!< 1st Adaptive boost trip level, effective only when DCIE is set to 1 */
    ...
    TFA9866_BF_DCTRIPT= 0x7584,    /*!< Offset between Booster voltage and audio signal output amplitude, effective only when DCIE is 1 */
    TFA9866_BF_BYPDCLPF= 0x75d0,    /*!< Bypass control of DCDC control low pass filter for quantization noise suppression */
    ...
    TFA9866_BF_DCPTC = 0x8401,    /*!< Voltage sense dc protection time                   */
    TFA9866_BF_DCPL  = 0x842c,    /*!< Voltage sense dc protection level                  */
    ...
    TFA9866_BF_DCDIS = 0xd190,    /*!< DCDC on/off                                        */
    TFA9866_BF_PSTSLP= 0xdd70,    /*!< Amplifier slope control                            */
    TFA9866_BF_BSTSLP= 0xdd80,    /*!< Booster slope control                              */
...
#define TFA9866_NAMETABLE static tfaBfName_t Tfa9866DatasheetNames[]= {\
...
#define TFA9866_BITNAMETABLE static tfaBfName_t Tfa9866BitNames[]= {\
...
#define TFA9866_IRQ_NAMETABLE static tfaIrqName_t Tfa9866_irq_names[]= {\
	{ 0, "STVDDS"},\
	{ 1, "STBSTOC"},\
	{ 2, "STOTDS"},\
	{ 3, "STOCPR"},\
